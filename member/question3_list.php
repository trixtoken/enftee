...
$tpl=new Template;
$tpl->define(array(
    'contents'  =>'member/question3_list.tpl',
...
if($_GET['pe_idx']){
	$search_query .= " and pe_idx = '".$_GET['pe_idx']."' ";
}
$querys[] = "pe_idx=".$_GET['pe_idx'];

$order_query = "order by qu_idx desc";

$query = (is_array($querys) && count($querys) > 0) ? implode("&", $querys) : "";

$sql = "select * from rb_question where mb_id = '".$member['mb_id']."' and qu_type = 2 $search_query $order_query";
$data = sql_list($sql);

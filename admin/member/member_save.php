...
if($_POST['mode'] == "insert"){
	...
	alert("회원이 추가 되었습니다.", "./member_list.php?$query");
	...
	alert("회원이 수정 되었습니다.", "./member_list.php?$query");
	...
	alert("회원이 삭제되었습니다.", "./member_list.php?$query");
	...
	alert("회원이 삭제 되었습니다.", "./member_list.php?$query");
}

alert("잘못된 접근입니다.", "./member_list.php?$query");
?>
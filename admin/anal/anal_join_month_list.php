...
$tpl=new Template;
$tpl->define(array(
    'contents'  =>'anal/anal_join_month_list.tpl',
	'body'  =>'inc/body.tpl',
	'top'  =>'inc/top.tpl',
...
$search_query = " and SUBSTRING(mb_regdate, 1, 4) >= '$s_str' ";
...
$sql = " select count(*) as cnt, SUBSTRING(mb_regdate, 1, 7) as da
          from rb_member  where 1
          $sql_search
		  group by SUBSTRING(mb_regdate, 1, 7)

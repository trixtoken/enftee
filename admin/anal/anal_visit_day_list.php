...
$tpl=new Template;
$tpl->define(array(
    'contents'  =>'anal/anal_visit_day_list.tpl',
	'body'  =>'inc/body.tpl',
	'top'  =>'inc/top.tpl',
...
$search_query = " and SUBSTRING(lh_regdate, 1, 7) >= '$s_str' ";
...
$sql = " select count(*) as cnt, SUBSTRING(lh_regdate, 1, 10) as da
          from rb_login_history  where 1
          $sql_search
		  group by SUBSTRING(lh_regdate, 1, 10)

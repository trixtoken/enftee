...
$tpl=new Template;
$tpl->define(array(
    'contents'  =>'product/review_list.tpl',
	'body'  =>'inc/body.tpl',
	'top'  =>'inc/top.tpl',
...
$order_query = "order by q.pr_idx desc";
...
// 전체 데이터수 구하기
$sql_total = "select * from rb_product_review as q left join rb_product as p on q.pd_idx = p.pd_idx where 1 $search_query";
...
if($total){
	...
	$sql = "select * from rb_product_review as q left join rb_product as p on q.pd_idx = p.pd_idx where 1 $search_query $order_query $limit_query";
	$data = sql_list($sql);

...
$tpl=new Template;
$tpl->define(array(
    'contents'  =>'product/qna1_list.tpl',
	'body'  =>'inc/body.tpl',
	'top'  =>'inc/top.tpl',
...
$order_query = "order by q.qu_idx desc";
...
// 전체 데이터수 구하기
$sql_total = "select * from rb_question as q  where qu_type = 1 $search_query";
...
if($total){
	...
	$sql = "select * from rb_question as q  where qu_type = 1 $search_query $order_query $limit_query";
	$data = sql_list($sql);

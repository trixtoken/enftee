...
$order_query = "order by p.pe_idx desc";
...
// 전체 데이터수 구하기
$sql_total = "select * from rb_pet as p where 1 $search_query";
...
if($total){
	...
	$sql = "select * from rb_pet as p where 1 $search_query $order_query $limit_query";
	$data = sql_list($sql);

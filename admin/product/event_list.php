...
$tpl=new Template;
$tpl->define(array(
    'contents'  =>'product/event_list.tpl',
	'body'  =>'inc/body.tpl',
	'top'  =>'inc/top.tpl',
...
if($_GET['wi_status1'] != ""){
	$search_query .= " and mn.wi_status1 = '".$_GET['wi_status1']."' ";
}
$querys[] = "wi_status1=".$_GET['wi_status1'];
$querys_page[] = "wi_status1=".$_GET['wi_status1'];

if($_GET['wi_status2'] != ""){
	$search_query .= " and mn.wi_status2 = '".$_GET['wi_status2']."' ";
}
$querys[] = "wi_status2=".$_GET['wi_status2'];
$querys_page[] = "wi_status2=".$_GET['wi_status2'];
...
// 전체 데이터수 구하기
$sql_total = "select * from rb_event as mn where 1 $search_query";
...
if($total){
	...
	$sql = "select * from rb_event as mn where 1 $search_query $order_query $limit_query";
	$data = sql_list($sql);

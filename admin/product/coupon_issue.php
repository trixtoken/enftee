...
$tpl=new Template;
$tpl->define(array(
    'contents'  =>'product/coupon_issue.tpl',
	'body'  =>'inc/body.tpl',
	'top'  =>'inc/top.tpl',
...
$order_query = "order by c.cp_idx desc";
...
// 전체 데이터수 구하기
$sql_total = "select * from rb_coupon_record as cr left join rb_coupon as c on cr.cp_idx = c.cp_idx where cc_idx = '0' $search_query";
...
if($total){
	...
	$sql = "select * from rb_coupon_record as cr left join rb_coupon as c on cr.cp_idx = c.cp_idx where cc_idx = '0' $search_query $order_query $limit_query";

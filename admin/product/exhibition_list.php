...
$tpl=new Template;
$tpl->define(array(
    'contents'  =>'product/exhibition_list.tpl',
	'body'  =>'inc/body.tpl',
	'top'  =>'inc/top.tpl',
...
$order_query = "order by c.ex_sort asc";
...
// 전체 데이터수 구하기
$sql_total = "select * from rb_exhibition as c where 1 $search_query";
...
if($total){
	...
	$sql = "select * from rb_exhibition as c where 1 $search_query $order_query $limit_query";
	$data = sql_list($sql);
